...
//   }
                        ...
                        <table id="example1" class="table table-bordered table-striped">
                            ...
                            $limit = $_GET["limit"];
                            $pageper = 10;
                            $select_path1 = "SELECT * FROM members";
                            $var1 = mysql_query($select_path1);
                            $numrows = mysql_num_rows($var1);
                            $noofpage = ceil($numrows / $pageper);

                            $sql = "SELECT * FROM members order by created DESC LIMIT $pageper OFFSET $limit";
                            ...
                            <div id="example2_paginate" class="dataTables_paginate paging_simple_numbers">
                                <ul class="pagination">
                                    ...
                                    <li id="example2_next" class="paginate_button next">
                                        <a href="memlistsu.php?limit=<?php echo ($noofpage - 1) * 10; ?>" aria-controls="example2" data-dt-idx="7" tabindex="0">Last</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
